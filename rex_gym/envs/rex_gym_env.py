...
class RexGymEnv(gym.Env):
    """The gym environment for Rex.
      ...
      on how far Rex walks in 1000 steps and penalizes the energy expenditure.
    ...
    def __init__(self,
        ...
        # print('motor_velocity_obs_index = ', self.motor_velocity_obs_index )
        # print('motor_torque_obs_index = ',  self.motor_torque_obs_index)
        # print('base_orientation_obs_index = ', self.base_orientation_obs_index)
        ...
        self.cycle_len = int(TOTAL_CYCLE_TIME/self._time_step)
    ...
    def reset(self, initial_motor_angles=None, reset_duration=1.0):
        ...
        return self._get_observation_np() # updated this for baselines
