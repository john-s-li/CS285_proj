...
class RexStandupEnv(rex_gym_env.RexGymEnv):
	...
	# COMMENT: the termination condition needs to be more robust...Rex can
	# have chest to ground (front legs fallen but hind legs up)
	# with no significant roll nor pitch change (need to handle this case) ...
	# TD3 seems to converge to this policy
    def is_fallen(self):
